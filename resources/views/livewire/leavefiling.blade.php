      ...
      <div class="col-md-6">
        ...
        <div>
          <ul class="nav nav-pills nav-fill">
            <li class="nav-item">
              <a style="background-color:#1b2641; color: #595c62" class="nav-link icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);" href="/">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock" viewBox="0 0 16 16">
                    <path d="M8 3.5a.5.5 0 0 0-1 0V9a.5.5 0 0 0 .252.434l3.5 2a.5.5 0 0 0 .496-.868L8 8.71z"/>
                    <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16m7-8A7 7 0 1 1 1 8a7 7 0 0 1 14 0"/>
                  </svg>Time-In/Time-Out
                  </a>
            </li>
            <li class="nav-item">
              <a style="background-color:#111829; color: #e2c56d" class="nav-link icon-link active icon-link-hover" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);" href="{{ route('leavefiling') }}">
            ...
            <div class="mb-3">
                ...
                <select id="shift" class="form-control" wire:model="shift">
                    ...
                    @foreach ($shifts as $shift)
                        <option value="{{ $shift }}" wire:key="shift-{{ $shift }}">
                            {{ $shift }}</option>
                    @endforeach
                </select>
                @error('shift')
